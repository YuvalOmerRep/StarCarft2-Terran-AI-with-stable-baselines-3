...
protoss_structures_list = [UId.ASSIMILATOR, UId.CYBERNETICSCORE, UId.DARKSHRINE, UId.FLEETBEACON, UId.FORGE,
                           UId.GATEWAY, UId.NEXUS, UId.PHOTONCANNON, UId.PYLON, UId.ROBOTICSBAY, UId.ROBOTICSFACILITY,
                           UId.STARGATE, UId.TEMPLARARCHIVE, UId.TWILIGHTCOUNCIL, UId.WARPGATE, UId.SHIELDBATTERY]

terran_unit_list = [UId.SCV, UId.MARINE, UId.SIEGETANK, UId.MEDIVAC, UId.MARAUDER]
